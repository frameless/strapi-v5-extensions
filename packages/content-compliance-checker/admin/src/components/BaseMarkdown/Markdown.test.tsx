...
import { BaseMarkdown } from './index';
describe('Markdown', () => {
  it('should render the Markdown component', () => {
    const content = '<p>Hello World!</p>';
    const { container } = render(<BaseMarkdown>{content}</BaseMarkdown>);
  ...
  it('should render the Markdown component with richtext class', () => {
    const { container } = render(<BaseMarkdown>Hello World!</BaseMarkdown>);
    const text = container.querySelector(':only-child');
    expect(text).toBeInTheDocument();
  });
  it('should render custom component', () => {
    const { container } = render(
      <BaseMarkdown components={{ p: (props) => <p className="custom-component" {...props} /> }}>
        {'<p>Hello World!</p>'}
      </BaseMarkdown>,
    );
  ...
  describe('iframe', () => {
    ...
    it('should not render iframe elements', () => {
      const { container } = render(<BaseMarkdown>{exampleIframe}</BaseMarkdown>);
  ...
  describe('Youtube iframe', () => {
    ...
    it('should render Youtube iframe', () => {
      const { container } = render(<BaseMarkdown>{youtubeIframe}</BaseMarkdown>);
      const iframe = container.querySelector('iframe');
  ...
  describe('Components', () => {
    ...
    it('should render Utrecht Table component', () => {
      ...
      const { container } = render(<BaseMarkdown>{contentTable.toString()}</BaseMarkdown>);
